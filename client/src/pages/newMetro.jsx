...
const NewTrain = () => {
  ...
  const [metroNumber, setTrainNum] = useState('');
  ...
  const handleSubmit = async () =>{
    ...
    const inputs = {metroName, metroNumber, origin, destination, departureTime: startTime, arrivalTime, basePrice, totalSeats};

    await axios.post('http://localhost:6001/add-metro', inputs).then(
      async (response)=>{
    ...
    <div className='NewTrainPage'>
      ...
      <span className='newTrainSpan1'>
        <div className="form-floating mb-3">
          ...
          <div className="form-floating mb-3">
                <input type="text" className="form-control" id="floatingInputmobile" value={metroNumber} onChange={(e)=> setTrainNum(e.target.value)} />
